...
const config = {
  cacheRemote: true,
  version: version + "::",
  preCachingItems: ["index.html", "offline.html", "404.html", "sw.js"],
  blacklistCacheItems: ["service-worker.js"],
  offlineImage:
    '<svg role="img" aria-labelledby="offline-title"' +
    ' viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">' +
    '<title id="offline-title">Offline</title>' +
    '<g fill="none" fill-rule="evenodd"><path fill="#aaa" d="M0 0h400v300H0z"/>' +
    '<text fill="#222" font-family="monospace" font-size="32" font-weight="bold">' +
...
self.addEventListener("fetch", (event) => {
  ...
  if (
    ...
    (config.blacklistCacheItems.length > 0 &&
      config.blacklistCacheItems.indexOf(url.pathname) !== -1)
  ) {
